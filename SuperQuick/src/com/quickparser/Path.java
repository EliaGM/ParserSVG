...
public class Path {
	...
	public Path(float opacity, String fill,String matriz) {
		super();
	...
	public Path(float opacity, String matriz, LinealGradient lg, boolean haymatrix) {
		super();
		this.opacity = opacity;
		this.matriz = matriz;
		this.lg = lg;
	...
	public Path(float opacity, String matriz, RadialGradient rg, boolean haymatrix) {
		super();
		this.opacity = opacity;
		this.matriz = matriz;
		this.rg = rg;
	...
	public Path(float opacity, String stroke, float width,
	...
	public Path(float opacity, float width, float mitter,
	...
	public void construirSTK1(){
		String cadena = "\"2 STK 1 "+this.stroke+" ";
	...
	public void construirFill2(){
		String cadena = "\"2 fill2 "+this.lg.getId()+" "+this.lg.getX1()+" "+this.lg.getY1()+" "+this.lg.getX2()+" "+this.lg.getY2()+" ";
	...
	public void construirFill3(){
		String cadena = "\"2 fill3 "+this.rg.getId()+" "+this.rg.getX1()+" "+this.rg.getY1()+" "+this.rg.getR()+" ";
	...
	public void construirSTK2(){
		String cadena = "\"2 STK 2"+this.lg.getId()+" "+this.lg.getX1()+" "+this.lg.getY1()+" "+this.lg.getX2()+" "+this.lg.getY2()+" ";
	...
	public void construirSTK3(){
		String cadena = "\"2 STK 3"+this.rg.getId()+" "+this.rg.getX1()+" "+this.rg.getY1()+" "+this.rg.getR()+" ";
		if(haymatrix){
			cadena +="X "+this.rg.getA()+" "+this.rg.getB()+" "+this.rg.getC()+" "+this.rg.getD()+" "+this.rg.getE()+" "+this.rg.getF()+" ";
		}
		cadena += this.width+" ";cadena += this.mitter+" ";
